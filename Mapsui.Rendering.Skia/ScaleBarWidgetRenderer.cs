    ...
    public static class ScaleBarWidgetRenderer
    {
            ...
            float layerOpacity)
        {
            ...
            else
            {
                ...
                _paintScaleText.Typeface = SKTypeface.FromFamilyName(scaleBar.Font.FontFamily, SKFontStyle.Bold);
                ...
                _paintScaleTextStroke.Typeface = SKTypeface.FromFamilyName(scaleBar.Font.FontFamily, SKFontStyle.Bold);
